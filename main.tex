...
As an argument in favor of their design, authors present types inferred from running R code, and this paper reports on an experiment where \tool was run on \UFNumFunctions R functions, generating \UFSignatrAdditionalSignatures (\UFSignatrAdditionalSignaturesRatio times) more unique call signatures than were obtained from running existing code alone.
