...
\AT{Leveraging existing code is a good start, but falls short.}
...
The fuzzing approach takes advantage of the aforementioned database of values, and is similar in spirit to mutation-based fuzzing (where instead of mutating arguments to previous calls, new argument values are selected based on previous ones).
