...
Generating the database took about 1 day \TODO{@pierre get the more precise number and with the 3 phases: running each file, merging generating the indexes} and takes \DBFileSize of disk space.
