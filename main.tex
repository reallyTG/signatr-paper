...
We present the insights of its design and implementation, and report on an experiment where we fuzzed \UFNumFunctions R functions generating \UFSignatrAdditionalSignatures (\UFSignatrAdditionalSignaturesRatio) more unique call signatures over just using program execution traces.
