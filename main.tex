...
Retrofitting type systems onto dynamic languages can help programmers write more reliable code, as designing a type system that accurately captures the semantics of the language while being usable and useful to programmers can be tricky, as the balance between expressiveness and complexity is elusive.
